...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="w-full flex sm:flex-row flex-col justify-center min-h-screen gap-10 max-container"
    >
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-f-screen max-xl py-40 bg-primary bg-hero bg-cover bg-center">
